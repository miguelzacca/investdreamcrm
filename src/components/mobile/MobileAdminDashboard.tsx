...
import styles from "./MobileAdminDashboard.module.css";
...
export function MobileAdminDashboard() {
  ...
  }, [mode, successMsg]); // refresh preview after each submission
  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        <h1 className={styles.headerTitle}>Novo Lead</h1>
        <button
      ...
      <main className={styles.content}>
        <p className={styles.description}>
          Interface mobile exclusiva para administradores. Crie e atribua leads rapidamente para sua equipe.
        </p>
        ...
        <div className={styles.tabs}>
          ...
          >
            <span style={{ fontSize: "1.1rem" }}>🔄</span> Fila Automática
          </button>
          <button
            type="button"
          ...
          >
            <span style={{ fontSize: "1.1rem" }}>🎯</span> Específico
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          {mode === "direct" && (
            <div className={styles.agentSelect}>
              <label className={styles.agentLabel} htmlFor="mobile-agent">
                Corretor *
              </label>
              <select
                id="mobile-agent"
          ...
          <div className={styles.row}>
            ...
            <Input
              ...
              placeholder="Ex: Apart. 2 quartos"
              value={form.interest}
