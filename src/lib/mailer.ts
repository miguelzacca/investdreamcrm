...
function buildEmailHtml(options: {
  ...
  const { agentName, leadName, leadWhatsApp, leadInterest, leadSource, isFollowUp } = options;
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:14px 24px;border-bottom:1px solid #e2e8f0;">
                    <p style="margin:0;font-size:12px;color:#94a3b8;">WhatsApp</p>
                    <p style="margin:2px 0 0;font-size:15px;color:#1e293b;font-weight:500;">${leadWhatsApp}</p>
                  </td>
                </tr>` : ""}
                ${leadInterest ? `
                <tr>
